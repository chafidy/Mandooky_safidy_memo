...
<div class="bg-light">
    <div class="container py-5 mt-4">
        <h2 class="text-center wow fadeIn"><?php echo $title ?> | Détails recettes</h2>
        <hr class="m-0">
        <div class="w-100 d-flex justify-content-between mb-2">
            <div class="col-auto  wow slideInLeft">
                <span class="text-muted"><small><i class="fa fa-user"></i>Crée par: <?php echo $author ?></small></span>
            </div>
            <div class="col-auto wow slideInRight">
                <span class="text-muted"><small><i class="fa fa-calendar-day"></i> Publié: <?php echo date("M d, Y H:i",strtotime($date_created)) ?></small></span>
            </div>
        </div>
        ...
        <div class="content">
            ...
            <h2 class="strikeBg text-center">Ingrédients</h2>
            <div class="my-2">
                <?php echo html_entity_decode($ingredients) ?>
            </div>
            <h2 class="strikeBg text-center">Etapes de cuisson</h2>
            <div class="my-2">
                <?php echo html_entity_decode($step) ?>
            </div>
            <h2 class="strikeBg text-center">Autres Informations</h2>
            <div class="my-2">
        ...
        <hr>
        <div class="col-md-7">
            <h2 class="wow fadeIn"><b>Commentaires:</b></h2>
            <hr>
            <?php 
            ...
            <form action="" id="comment-form" class="wow bounceInUp">
                ...
                <div class="form-group">
                    <textarea name="message" id="message" cols="30" rows="4" class="form-control rounded-0" placeholder="Ecrit votre commentaire ici."></textarea>
                </div>
                <div class="form-group">
                    <div class="w-100 d-flex justify-content-end my-2">
                        <div class="col-auto">
                            <button class="btn btn-primary btn-sm rounded-0">Enregistrer</button>
                            <button class="btn btn-dark btn-sm rounded-0" type="reset">Annuler</button>
                        </div>
                    </div>
                </div>
            </form>
