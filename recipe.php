        ...
        <div class="col-12">
            <div class="row mx-0 d-flex justify-content-cente mb-2">
                ...
                <div class="input-group mb-3">
                    <input type="text" id="search" class="form-control rounded-0" placeholder="Rechercher ici" aria-label="Rechercher ici" aria-describedby="basic-addon2" autocomplete="off">
                        ...
                        <div class="card-body ">
                            ...
                            <div class="w-100 d-flex justify-content-end">
                                <div class="col-auto flex-grow-1">
                                    <div class="text-muted truncate-1" title="<?php echo $row['author'] ?>"><small><i>Posté par: <?php echo $row['author'] ?></i></small></div>
                                </div>
                                <div class="col-auto">
                                    <a href="./?page=view_recipe&rid=<?php echo $row['recipe_id'] ?>" class="btn btn-sm btn-primary bg-gradient rounded-0 py-0">Voir Recette</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <?php if(!$qry->fetchArray()): ?>
                <center><i><small class="text-muted">Aucun liste de recette.</small></i></center>
            <?php endif; ?>
        </div>
    </div>
</div>
