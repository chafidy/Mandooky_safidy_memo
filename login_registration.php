        ...
        <div class="row">
                ...
                <form action="" id="login-form">
                    ...
                    <div class="form-group my-1 pt-2">
                        <div class=" w-100 d-flex justify-content-end">
                            <button class="btn btn-sm btn-primary rounded-0">Connexion</button>
                        </div>
                    </div>
                </form>
            </div>
            <div class="col-md-8 border-start py-5 my-4">
                <div class="col-sm-6 offset-sm-2">
                    <h3><b>Créer un nouvel compte</b></h3>
                    <form action="" id="sign-up">
                        ...
                        <div class="form-group my-1 pt-2">
                            <div class=" w-100 d-flex justify-content-end">
                                <button class="btn btn-sm btn-primary rounded-0">Créer un compte</button>
                            </div>
                        </div>
                    </form>
                </div>
