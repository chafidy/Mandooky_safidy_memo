...
<head>
    ...
    <title><?php echo ucwords(str_replace('_',' ',$page)) ?> | Mandooky</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse " id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle <?php echo in_array($page,array('categories','recipe'))? 'active' : '' ?>" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">Catégories</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="./?page=categories">Listes Catégories</a></li>
                            <?php 
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'about')? 'active' : '' ?>" aria-current="page" href="./?page=about">A propos</a>
                    </li>
                </ul>
            </div>
            <div>
            <div class="">
                <?php if(isset($_SESSION['user_id'])): ?>
                    <div class="dropdown">
                    <a class="btn btn-secondary bg-transparent  text-light border-0" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">Salut, <?php echo $_SESSION['fullname'] ?></a>
                    <ul class="dropdown-menu">
                        <li>
                            <a class="dropdown-item" href="./?page=posts">Mes recettes</a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="./?page=manage_account">Mon profil</a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="Actions.php?a=user_logout">Déconnexion</a>
                        </li>
                    </ul>
                    </div>
                <?php else: ?>
