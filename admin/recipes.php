...
<div class="card">
    <div class="card-header d-flex justify-content-between">
        <h3 class="card-title">Liste de recette</h3>
        <div class="card-tools align-middle">
            <a class="btn btn-dark btn-sm py-1 rounded-0" href="./?page=manage_recipe" id="create_new">Ajouter une nouvelle</a>
        </div>
    </div>
    <div class="card-body">
        <table class="table table-hover table-striped table-bordered">
            ...
            <thead>
                <tr>
                    ...
                    <th class="text-center p-0">Auteur</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="py-0 px-1 text-center">
                        <?php 
                        if($row['status'] == 1){
                            echo  '<span class="py-1 px-3 badge rounded-pill bg-success"><small>Publié</small></span>';
                        }else{
                            echo  '<span class="py-1 px-3 badge rounded-pill bg-danger"><small>Privé</small></span>';
                    ...
                    <td class="text-center py-0 px-1">
                        <div class="btn-group" role="group">
                            ...
                            <li><a class="dropdown-item" href="../?page=view_recipe&rid=<?php echo $row['recipe_id'] ?>" data-id = '<?php echo $row['recipe_id'] ?>' target="_blank">Voir Details</a></li>
                            <li><a class="dropdown-item" data-id = '<?php echo $row['recipe_id'] ?>' href="./?page=manage_recipe&id=<?php echo $row['recipe_id'] ?>">Editer</a></li>
                            <li><a class="dropdown-item delete_data" data-id = '<?php echo $row['recipe_id'] ?>' data-name = '<?php echo $row['title'] ?>' href="javascript:void(0)">Supprimer</a></li>
                            </ul>
                        </div>
                    </td>
                </tr>
