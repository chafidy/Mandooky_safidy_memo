            ...
            <div class="row h-100">
                <div class="col-md-5">
                    <div class="w-100 d-flex border-bottom border-dark py-1 mb-1">
                        <div class="fs-5 col-auto flex-grow-1"><b>Listes de catégories</b></div>
                    ...
                    <div class="overflow-auto border rounded-1 border-dark">
                        <ul class="list-group">
                            ...
                            <?php if(!$cat_qry->fetchArray()): ?>
                                <li class="list-group-item text-center">Aucun donnée listé.</li>
                            <?php endif; ?>
                        </ul>
                    </div>
                </div>
                <div class="col-md-7">
                    <div class="fs-5 col-auto flex-grow-1"><b>Liste de contenu de site</b></div>
                    <form action="" id="settings-form">
                        <div class="form-group">
                            <label for="welcome" class="control-label">Contenu de bienvenu</label>
                            <textarea name="welcome" id="welcome" cols="30" rows="3" class="form-control rounded-0 summernote" data-placeholder="Ecrit votre contenu ici." data-height="40vh" required><?php echo is_file('../welcome.html') ? file_get_contents('../welcome.html') : '' ?></textarea>
                        </div>
                        <div class="form-group">
                            <label for="about" class="control-label">Contenu à propos</label>
                            <textarea name="about" id="about" cols="30" rows="3" class="form-control rounded-0 summernote" data-placeholder="Ecrit votre contenu ici." data-height="40vh" required><?php echo is_file('../about.html') ? file_get_contents('../about.html') : '' ?></textarea>
                        </div>
