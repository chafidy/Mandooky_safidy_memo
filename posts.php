...
<div class="card">
    <div class="card-header d-flex justify-content-between">
        ...
        <div class="card-tools align-middle">
            <a class="btn btn-dark btn-sm py-1 rounded-0" href="./?page=manage_recipe" id="create_new">Créer une nouvelle</a>
        </div>
    </div>
    <div class="card-body">
                ...
                <tr>
                    ...
                    <td class="text-center py-0 px-1">
                        <div class="btn-group" role="group">
                            ...
                            <li><a class="dropdown-item" href="./?page=view_recipe&rid=<?php echo $row['recipe_id'] ?>" data-id = '<?php echo $row['recipe_id'] ?>' target="_blank">Voir Détails</a></li>
